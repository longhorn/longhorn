...
| defaultSettings.backupExecuteTimeout | Number of minutes that Longhorn sets the timeout for the backup engine execution. When the value is "0", automatic deletion is disabled. |
