...
| global.nodeSelector | object | `{}` | Node selector for nodes that can run user-deployed Longhorn components (Manager, UI, Driver Deployer). |
| global.tolerations | list | `[]` | Toleration for nodes that can run user-deployed Longhorn components (Manager, UI, Driver Deployer). |
