...
| defaultSettings.upgradeResponderURL | Upgrade responder will notify users the available versions of Longhorn for upgrade. The default value is "https://longhorn-upgrade-responder.rancher.io/v1/checkupgrade". |
