...
| defaultSettings.endpointNetworkForRWXVolume | A dedicated network for mounting RWX (ReadWriteMany) volumes. When unspecified, Longhorn uses the Kubernetes cluster network. |
