...
| Release   | Version | Type           | Release Note (Changelog)                                       | Important Note                                              | Active Maintenance |
|-----------|---------|----------------|----------------------------------------------------------------|-------------------------------------------------------------| -------------------|
| **1.5***  | 1.5.3   | Stable         | [🔗](https://github.com/longhorn/longhorn/releases/tag/v1.5.3) | [🔗](https://longhorn.io/docs/1.5.3/deploy/important-notes) | ✅                 |
