...
In high performance evn, UBLK frontend may have better performance compares to NVME-TCP.
Ref https://github.com/longhorn/longhorn/wiki/Longhorn-Performance-Investigation
...
1. UBLK initiator set `UblkInfo.UblkID` to the avaiable ID
...
Provide the user option to set num queue and queue depth
How to solve the orphan device when IM crash. Check /sys/