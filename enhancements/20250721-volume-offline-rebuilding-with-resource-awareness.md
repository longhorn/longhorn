...
- If the degraded volumes are attached by the offline rebuilding, Longhorn will check whether the replica rebuilding is starting with a backoff mechanism.
...
const (
  ...
  offlineRebuildingBackoffMaxInterval = 3 * time.Minute
