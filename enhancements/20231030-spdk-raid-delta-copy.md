...
The snapshot checksum can be retrieved as an xattr, and a new API will be created to calculate the checksum of a previously created
snapshot and to store it as an xattr.
...
## Note on the use of RAID superblock
