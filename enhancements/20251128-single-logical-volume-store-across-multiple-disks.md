...
- Create V2 Block Disks with `multiple` disk paths.
    - V2 Backing Image behaves normally.
    - Disk capacity is aggregated across all paths.
    - Volumes can be created and attached on this disk.

- Delete V2 Block Disks with `multiple` disk paths.
